                    ...
                    <div class="col-md-8">
                        <div class="card card-light">
                            <div class="card-header">
                                <h3 class="card-title">Editar categoría
                                </h3>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <small class="text-muted">Así aparecerá el nombre.</small>
                                    @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="text-muted">&nbsp;&nbsp;El "slug" es la versión más adaptada para links
                                    </small>
                        ...
                        <div class="card card-light">
                            <div class="card-header">
                                ...
                                <small>&nbsp;&nbsp;La descripción puede aparecer en algunas instancias por defecto
                                </small>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse"
                                        title="Collapse">
                                ...
                                <div class="card-body pb-0">
                                    <div class="form-group">
                                        ...
                                        <select required="required" name="status" id="inputStatus" class="form-control custom-select">
                                            ...
                                            <option value="1" {{ old('published', $category->status) == 1 ? 'selected' : '' }}>Publicado</option>
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body pt-0 pb-0">
                                    <div class="form-group">
                                       @if ($category->image)
                                       <div class="form-group">
                                        <label for="delete_image">Eliminar</label>
