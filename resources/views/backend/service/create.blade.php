...
@section('content_header')
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="m-0">Añadir servicio</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item active">Añadir servicio</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-8">
                    <div class="card card-light">
                        <div class="card-header">
                            <h3 class="card-title">Añadir servicio
                            </h3>
                    ...
                    <div class="card card-light">
                        <div class="card-header">
                            ...
                            <small class="text-muted pl-2">Sin signos ni espacios (solo números)</small>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="number" name="sale_price" placeholder="Price"
                                        ...
                                        <p class="mb-0 text-muted small">Precio en oferta</p>
                                    @error('sale_price')
                                        <span class="text-danger">
                                            {{ $message }}
                                        </span>
                        ...
                        <div class="card-body  pt-0 pb-0">
                            <div class="form-group">
                                ...
                                <textarea placeholder="Service description here for seo..." class="form-control" name="meta_description"
                                    id="" cols="0" rows="4" value="{{ old('meta_description') }}">{{ old('meta_description') }}</textarea>
                            </div>
                        </div>
                        <div class="card-body pt-0 pb-0">
                            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="sticky-top">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <select required="required" name="status" id="inputStatus"
                                        ...
                                        <option disabled="" value="">Seleccionar opción
                                        </option>&gt;
                                        <option class="published" value="1" selected>
                                            Publicado
                                        </option>
                                        <option value="0"> En borrador
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="card card-primary ">
                            ...
                            <div class="card-body pt-0 pb-0">
                                <div class="form-group">
                                    <small class="text-red">&nbsp;&nbsp;Nota: tamaño: Ancho-1200px Altura: 800px
                                    </small>
